...
export const config = {
  ...
  dark: vars({
    /* Primary - Navy (inverted) */
    "--color-primary-50": "17 29 67",
    "--color-primary-100": "29 47 104",
    "--color-primary-200": "41 70 145",
    "--color-primary-300": "50 94 180",
    "--color-primary-400": "60 121 201",
    "--color-primary-500": "79 155 218",
    "--color-primary-600": "130 192 234",
    "--color-primary-700": "180 223 247",
    "--color-primary-800": "220 241 251",
    "--color-primary-900": "244 248 250",

    /* Secondary - Blue (inverted) */
    "--color-secondary-50": "24 24 85",
    "--color-secondary-100": "43 39 136",
    "--color-secondary-200": "61 57 182",
    "--color-secondary-300": "80 77 213",
    "--color-secondary-400": "98 105 227",
    "--color-secondary-500": "121 142 234",
    "--color-secondary-600": "157 182 243",
    "--color-secondary-700": "197 217 250",
    "--color-secondary-800": "227 240 253",
    "--color-secondary-900": "247 249 251",

    /* Tertiary - Indigo (inverted) */
    "--color-tertiary-50": "31 23 74",
    "--color-tertiary-100": "56 36 122",
    "--color-tertiary-200": "81 52 169",
    "--color-tertiary-300": "107 70 203",
    "--color-tertiary-400": "130 98 220",
    "--color-tertiary-500": "155 135 229",
    "--color-tertiary-600": "181 176 240",
    "--color-tertiary-700": "214 214 249",
    "--color-tertiary-800": "235 240 252",
    "--color-tertiary-900": "248 250 251",

    /* Error - Cerise (inverted) */
    "--color-error-50": "70 17 21",
    "--color-error-100": "114 27 39",
    "--color-error-200": "158 39 59",
    "--color-error-300": "198 52 81",
    "--color-error-400": "221 78 113",
    "--color-error-500": "234 114 146",
    "--color-error-600": "237 162 185",
    "--color-error-700": "247 207 220",
    "--color-error-800": "251 240 238",
    "--color-error-900": "253 252 251",

    /* Success - Green (inverted) */
    "--color-success-50": "18 36 21",
    "--color-success-100": "26 59 27",
    "--color-success-200": "36 87 34",
    "--color-success-300": "42 114 41",
    "--color-success-400": "50 138 58",
    "--color-success-500": "72 166 96",
    "--color-success-600": "141 200 145",
    "--color-success-700": "196 229 195",
    "--color-success-800": "230 240 228",
    "--color-success-900": "245 247 243",

    /* Warning - Gold (inverted) */
    "--color-warning-50": "48 25 10",
    "--color-warning-100": "73 40 13",
    "--color-warning-200": "108 59 16",
    "--color-warning-300": "141 79 19",
    "--color-warning-400": "171 105 29",
    "--color-warning-500": "200 137 55",
    "--color-warning-600": "223 181 97",
    "--color-warning-700": "242 219 149",
    "--color-warning-800": "249 240 202",
    "--color-warning-900": "251 250 246",

    /* Info - Submarine (inverted) */
    "--color-info-50": "13 37 43",
    "--color-info-100": "19 61 60",
    "--color-info-200": "26 89 81",
    "--color-info-300": "28 117 104",
    "--color-info-400": "32 141 130",
    "--color-info-500": "45 170 167",
    "--color-info-600": "104 202 203",
    "--color-info-700": "161 229 232",
    "--color-info-800": "211 240 245",
    "--color-info-900": "240 246 246",

    /* Keep existing background, typography, and other utility colors */
    ...
    // ... rest of the dark theme utility colors remain unchanged
  }),
};
